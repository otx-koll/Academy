...
// 업로드 객체 생성할 때 필요한 인자 값
// 1. request
// 2. 업로드 할 폴더의 물리적 경로 (realPath)
// 3. 업로드 최대 파일 크기 제한
// 4. 파일명 한글처리 utf-8
// 5. 파일명 중복될 때 이름 변경 규칙 가진 객체를 전달
...
// 파라미터 값 가져와서 VO에 저장. MultipartRequest 로부터 찾음. 
...
/* 업로드한 폴더에 만약 똑같은 이름이 있다면 이름변경해서 뒤에 숫자 달림. 사용자가 원본은 a.ppt인데 실제론 변경되어서 a1.ppt */  
