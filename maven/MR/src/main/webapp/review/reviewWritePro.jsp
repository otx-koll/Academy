...
reviewVo.setId(multi.getParameter("id"));
reviewVo.setMvSubject(multi.getParameter("mvSubject"));
reviewVo.setSubject(multi.getParameter("subject"));
reviewVo.setContent(multi.getParameter("content"));

//글번호 가져와서 VO에 저장
int nextNum = JdbcUtils.getNextNum("review");
reviewVo.setNum(nextNum);

reviewVo.setRegDate(new Timestamp(System.currentTimeMillis()));
...
//글내용 상세보기 화면 reviewContent.jsp로 이동
response.sendRedirect("reviewContent.jsp?num=" + reviewVo.getNum() + "&pageNum=" + pageNum);
%>